...
define view entity ZBOOKING_C_AG
  as projection on ZBOOKING_R_AG
{
  key BookingUUID,
      TravelUUID,
      ...
      /* Associations */
      _BookingStatus,
      _BookingSupplement : redirected to composition child ZBKSPPL_C_AG,
      _Carrier,
      _Connection,
      _Customer,
      _Travel            : redirected to parent ZTRAVEL_C_AG
}
