CLASS zcl_vir_elem_sadl_ag DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_vir_elem_sadl_ag IMPLEMENTATION.
  METHOD if_sadl_exit_calc_element_read~calculate.
    DATA lt_original_data TYPE STANDARD TABLE OF ztravel_c_ag WITH DEFAULT KEY.
